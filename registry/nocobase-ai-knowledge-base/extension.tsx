    ...
    resources: [
      {
        ...
        meta: {
          ...
          i18nOptions: { ns: "nocobase-ai-knowledge-base" },
          icon: <BookOpenText />,
          description: "Five focused knowledge-base workflows and an isolated live workspace.",
    ...
    routes: defineAppRoutes([
      {
        ...
        children: [
          ...
          {
            name: "development.ai-knowledge-base.live",
            path: "live",
            lazy: () => import("./live/knowledge-bases-page"),
          },
          {
            name: "development.ai-knowledge-base.workspace",
            path: "live/:knowledgeBaseKey",
            lazy: () => import("./live/workspace-page"),
            children: [
              {
