...
This is the only command that intentionally replaces local previews under
`src/extensions`. Normal `pnpm dev`, `pnpm install`, and `pnpm registry:install`
do not overwrite an installed extension.
